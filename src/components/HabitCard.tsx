...
const HabitCard: React.FC<HabitCardProps> = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex justify-center items-center mt-4 w-full">
        {isSkipped ? (
          ...
          <div className="text-xl font-semibold text-center w-full" style={{ color: '#F97316' }}>
      ...
      <style>
        ...
        @keyframes wave-foam-secondary {
          ...
          50% {
            d: path("M0,-15V35C55,10,140,50,240,25C340,0,440,30,540,5C640,-20,740,10,840,-15C940,-40,1040,-15,1140,-40C1180,-50,1200,-25,1200,-20V35C1130,60,1040,20,940,45C840,70,740,30,640,55C540,80,440,40,340,65C240,90,140,50,40,75C10,85,0,55,0,35Z");
            opacity: 0.4;
          }
          100% {
            d: path("M0,-10V40C45,15,120,55,220,30C320,5,420,35,520,10C620,-15,720,15,820,-10C920,-35,1020,-10,1120,-35C1170,-45,1200,-20,1200,-10V40C1150,65,1060,25,960,50C860,75,760,35,660,60C560,85,460,45,360,70C260,95,160,55,60,80C20,90,0,60,0,40Z");
