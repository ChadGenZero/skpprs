  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Add Custom Skip</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="space-y-6 py-4">
          <Card className="border-dashed border-gray-300">
            <CardContent className="space-y-6 pt-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="emoji" className="flex items-center text-base">
                  Custom Emoji 
              ...
              <div className="space-y-2">
                <Label htmlFor="amount" className="flex items-center text-base">
                  Cost ($)
          ...
          <DialogFooter>
            <Button 
              type="submit" 
              className="w-full bg-bitcoin hover:bg-bitcoin/90 text-white py-6"
            >
              Add Custom Skip
            </Button>
          </DialogFooter>
